...
def generate_launch_description():
    pkg_share = launch_ros.substitutions.FindPackageShare(package='nbot_description').find('nbot_description')
    default_model_path = os.path.join(pkg_share, 'src/description/nbot_description.urdf')
